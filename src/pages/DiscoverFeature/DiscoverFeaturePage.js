...
const ICONS = {
  ...
  mentor:        <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="24" cy="14" r="6"/><path d="M12 38c0-7 5-12 12-12s12 5 12 12"/><path d="M24 26v6"/><path d="M20 30l4-4 4 4" opacity=".5"/></svg>,
