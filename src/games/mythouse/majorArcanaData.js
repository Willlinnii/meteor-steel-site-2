...
export const ARCANA_POSITIONS = [
  { number: 0,  type: 'element', correspondence: 'Air' },
  { number: 1,  type: 'planet',  correspondence: 'Mercury' },
  { number: 2,  type: 'planet',  correspondence: 'Moon' },
  { number: 3,  type: 'planet',  correspondence: 'Venus' },
  { number: 4,  type: 'zodiac',  correspondence: 'Aries' },
  { number: 5,  type: 'zodiac',  correspondence: 'Taurus' },
  { number: 6,  type: 'zodiac',  correspondence: 'Gemini' },
  { number: 7,  type: 'zodiac',  correspondence: 'Cancer' },
  { number: 8,  type: 'zodiac',  correspondence: 'Libra' },
  { number: 9,  type: 'zodiac',  correspondence: 'Virgo' },
  { number: 10, type: 'planet',  correspondence: 'Jupiter' },
  { number: 11, type: 'zodiac',  correspondence: 'Leo' },
  { number: 12, type: 'element', correspondence: 'Water' },
  { number: 13, type: 'zodiac',  correspondence: 'Scorpio' },
  { number: 14, type: 'zodiac',  correspondence: 'Sagittarius' },
  { number: 15, type: 'zodiac',  correspondence: 'Capricorn' },
  { number: 16, type: 'planet',  correspondence: 'Mars' },
  { number: 17, type: 'zodiac',  correspondence: 'Aquarius' },
  { number: 18, type: 'zodiac',  correspondence: 'Pisces' },
  { number: 19, type: 'planet',  correspondence: 'Sun' },
  { number: 20, type: 'element', correspondence: 'Fire' },
  { number: 21, type: 'planet',  correspondence: 'Saturn' },
];
